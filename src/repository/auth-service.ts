...
export async function verifyLineCode(code: string, redirectURI: string): Promise<verifyTokenResponse> {
...
export async function verifyDiscordCode(code: string, redirectURI: string): Promise<verifyTokenResponse> {
